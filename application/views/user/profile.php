	...
	<body class="register-page">
		<div class="register-box">
			...
			<div class="register-box-body">
				...
				<form method="post" action="<?php echo site_url('user/postprofile'); ?>">
					...
					<div class="form-group has-feedback">
						<input type="text" placeholder="Full name" class="form-control" value="<?php echo $result->a_name; ?>" name="a_name">
