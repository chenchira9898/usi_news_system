						...
						<div class="post-content-area">
							...
							<div class="entry-content">
								...
								<div class="post-media post-featured-image">
									...
									<img src="<?php echo base_url();?>gall/<?php  echo $dg->m_img;?>" class="img-fluid" alt="">
									...
									<li class="clearfix">
										<div class="post-block-style post-float clearfix">
											<div class="post-thumb">
												<a href="<?php echo site_url('home/scoop/'.$data6->a_id);?>">
										...
										<?php echo base_url('aimg/'.$data6->a_img);?>" alt="" />
											...
											<div class="post-content">
									 			<h2 class="post-title title-small">
									 				<a href="<?php echo site_url('home/scoop/'.$data6->a_id);?>"><?php echo $data6->a_title;?></a>
									 			</h2>
									 			<div class="post-meta">
