                        ...
                        <div class="box-header with-border">
                            ...
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="a_title" required value="<?php echo $result->a_title;?>" disabled>
                                    </div>
                                </div>
                                <div class="row">
                                    <hr/>
                                    ...
                                    <div class="col-sm-11">
                                        ...
                                        <div class="col-sm-5">
                                            ...
                                            <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                                ...
                                                <tbody>
                                                    <?php $k=1; if(!empty($rsimg)){ foreach ($rsimg as $img) { ?>
                                                    <tr role="row">
                                                        <td align="center"><?php echo $k; ?></td>
                                                        <td>
                                                            <a href="<?php echo base_url('gall/'.$img->m_img);?>" target="_blank">
                                                            <img src="<?php echo base_url('gall/'.$img->m_img);?>" width="100px">
                                                        </a>
                                                        ...
                                                        <td align="center"><?php echo date('d/m/Y',strtotime($img->m_date)); ?></td>
                                                        <td>
    <a class="btn btn-danger btn-xs" href="<?php  echo  site_url('articles/remove_img/'.$img->ref_a_id); ?>?m_id=<?php echo $img->m_id;?>&aid=<?php echo $img->ref_a_id;?>&act=del" role="button" onclick="return confirm('xxx');">
