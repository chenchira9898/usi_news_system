<div class="content-wrapper">
    ...
    <div class="container">
        ...
        <div class="box box-primary">
            ...
            <!-- form start -->
            <form role="form" action="<?php echo  site_url('member/m_position_adding'); ?>" method="post" class="form-horizontal">
                <div class="box-body">
                    <div class="form-group">
                        <div class="col-sm-4">
                        <label for="exampleInputEmail1">ชื่อตำแหน่ง</label> 
                        <input type="text" id="po_name" class="form-control" name="po_name" minlength="3" required>
                    </div>
                    </div>
                </div><!-- /.box-body -->
