                        ...
                        <div class="box-header with-border">
                            ...
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="a_title" required value="<?php echo $result->a_title;?>" readonly>
                                    </div>
                                </div>
                                <div class="row">
                                    <hr/>
                                            ...
                                            <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr role="row">
                                                        ...
                                                        <td>
                                                            <a class="btn btn-danger btn-xs" href="<?php  echo  site_url('article/remove_img/'.$img->ref_a_id); ?>?m_id=<?php echo $img->m_id;?>&aid=<?php echo $img->ref_a_id;?>&act=del" role="button"><i class="fa fa-fw fa-trash"></i> ลบ</a>
                                                        </td>
                                                    </tr>
                                                    <?php $k++; } } ?>
                                                </tbody>
